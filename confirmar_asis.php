...
<table width="744" class="bordes" border="0" align="center" cellpadding="1" cellspacing="2">
  <tr>
    <th colspan="3" align="center" valign="middle" bgcolor="#b60101" class="Estilo1 Estilo2" scope="col">CIERRE DE EVENTOS</th>
  </tr>
  <tr>
    ...
    <th width="31" align="center" valign="middle" bgcolor="#b60101" class="Estilo1 Estilo2" scope="col">Confirmar</th>
  </tr>
  <?php do { ?>
    <tr>
      ...
      <td bgcolor="#f2f0f0"><div align="center"><? echo "<a href='confirmar_asistencias.php?codigo=$row_evento[codigo]'>IR</a>" ?></div></td>
    </tr>

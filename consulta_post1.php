...
<body>
<form id="form1" name="form1" method="post" action="consulta_post.php" target="contenido" onsubmit="return validar()">
  <table width="324" border="0" align="center" cellpadding="1" cellspacing="2" class="bordes">
    <tr>
      <th height="28" colspan="2" bgcolor="#b60101" scope="col"><span class="Estilo4">Consulta Post-Electoral </span></th>
    </tr>

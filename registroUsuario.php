...
<form action="<?php echo $editFormAction; ?>" method="post" onsubmit="return validar()" name="form1" id="form1">
  <table width="552" border="0" align="center" cellpadding="1" cellspacing="2" class="bordes">
    <tr valign="baseline" bgcolor="#FF0000">
      <td colspan="2" align="right" nowrap="nowrap" bgcolor="#b60101"><div align="center" class="letrasblancas"><strong>REGISTRO DE USUARIOS </strong></div></td>
    </tr>
    <tr valign="baseline" bgcolor="#FF0000">
      <td width="212" align="right" nowrap="nowrap" bgcolor="#FFFFFF"><div align="right" class="Estilo1"><strong>Usuario:</strong></div></td>
      <td width="324" bgcolor="#FFFFFF"><input name="usuario" type="text" class="Estilo1" value="" size="20" maxlength="10" /></td>
    </tr>
    <tr valign="baseline" bgcolor="#FF0000">
    ...
    <tr valign="baseline">
      <td align="right" nowrap="nowrap" bgcolor="#FFFFFF"><strong>Nombre:</strong></td>
      <td bgcolor="#FFFFFF"><input name="nombre" type="text" class="Estilo5" size="32" maxlength="20" /></td>
    </tr>
    
    <tr valign="baseline">
      <td align="right" nowrap="nowrap" bgcolor="#FFFFFF"><strong>Cedula:</strong></td>
      <td bgcolor="#FFFFFF"><input name="cedula" type="text" class="Estilo5" size="32" maxlength="8" /></td>
    </tr>
    
    <tr valign="baseline" bgcolor="#FF0000">
      <td colspan="2" align="right" nowrap="nowrap" bgcolor="#b60101"><div align="right" class="Estilo1">
        <div align="center" class="letrasblancas"><strong>Permisos</strong></div>
      </div></td>
    </tr>
    <tr valign="baseline" bgcolor="#FF0000">
      <td height="92" colspan="2" align="right" nowrap="nowrap" bgcolor="#FFFFFF"><table width="385" border="0" align="center">
        <tr>
          <td width="210"><span class="Estilo1">
            <input name="registros" type="checkbox" class="Estilo1" value="registros" />
Registros </span></td>
          <td width="165"><span class="Estilo1">
...
Modificaciones </span></td>
          <td><span class="Estilo1">
            <input name="eliminaciones" type="checkbox" class="Estilo1" value="eliminaciones" />
Eliminaciones </span></td>
        </tr>
        <tr>
          <td height="29"><span class="Estilo1">
...
Administrar Usuarios </span></td>
    ...
    <tr valign="baseline" bgcolor="#FF0000">
      <td colspan="2" align="right" nowrap="nowrap" bgcolor="#b60101"><div align="center" class="Estilo1">

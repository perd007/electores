...
<table width="744" class="bordes" border="0" align="center" cellpadding="1" cellspacing="2">
  <tr>
    <th colspan="3" align="center" valign="middle" bgcolor="#b60101" class="Estilo1 Estilo2" scope="col">REPORTES DE ASISTENCIAS</th>
  </tr>
  <tr>
    ...
    <th width="31" align="center" valign="middle" bgcolor="#b60101" class="Estilo1 Estilo2" scope="col">VER</th>
  </tr>
  <?php do { ?>
    <tr>
      <td align="center" valign="middle" bgcolor="#f2f0f0"><?php echo $row_evento['fecha']; ?></td>
      <td align="center" bgcolor="#f2f0f0"><?php echo $row_evento['fecha']; ?></td>
      <td bgcolor="#f2f0f0"><div align="center"><? echo "<a href='reporte_asistencia.php?codigo=$row_evento[codigo]&evento=$row_evento[descripcion]&fecha=$row_evento[fecha]'>IR</a>" ?></div></td>
    </tr>

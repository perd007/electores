...
function Row($data)
   ...
   $this->CheckPageBreak($h);
	...
	function Header()
	{
	    ...
	    $this->Text(75,30,'Listado de Electores de la Alcaldia de Atures',0,'C', 0);
    $this->Ln(13);
	}
...
// Para realizar esto utilizaremos la funcion Row()
	...
	$pdf->Row(array('Nombre y Apellido', 'Cedula', 'Telefono', 'Sala de Batalla', 'Consejo Comunal')); // creamos nuestra fila con las columnas fecha(fecha de la visita al medico), medico(nombre del medico que nos atendio), consultorio y el diagnostico en esa visita
	$pdf->SetFont('Times','',9);
	$pdf->SetDrawColor(210,0,0);
...
for ($i=0; $i<$numfilas; $i++)   {       
	...
	$pdf->Row(array($cadena, $fila['cedula'], $fila['telefono'], $fila['sala'], $fila['consejo']));
		}
